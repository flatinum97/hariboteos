...
run : $(TARGET).img
	qemu-system-i386 -drive file=haribote.img,format=raw,index=0,if=floppy -enable-kvm
...
$(TARGET).bin : bootpack.o dsctbl.o graphic.o nasmfunc.o hankaku.o sprintf.o int.o fifo.o mouse.o keyboard.o memory.o sheet.o timer.o mtask.o
